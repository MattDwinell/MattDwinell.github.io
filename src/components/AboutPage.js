    ...
    return (
        <div id='about' className = 'about-page'><br></br><br></br>
           <div className = 'about-content'>
               ...
               <div class='blurb'>
              <p> I began my coding journey in a MERN stack web-development bootcamp. Before that, I worked in analytical chemistry as a data reviewer. While chemistry was challenging in its own way, I felt creatively stifled. Coding allows me to exercise both my creative side and my logical, problem-solving side. I'm currently a software engineer at SemanticBits, and prior to that I worked as a full-stack web developer at Cprime.  
                </p>
                <p>
